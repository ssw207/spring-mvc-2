...
public class ValidationItemControllerV2 {
    ...
    public void init(WebDataBinder dataBinder) {
        dataBinder.addValidators(itemValidator); // 컨트롤러가 호출될때마다 적용됨
    }
    ...
    public String addItem(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        ...
        if (item.getPrice() != null && item.getQuantity() != null) {
            ...
            if (resultPrice <= 100000) {
                ...
                bindingResult.addError(new ObjectError("item","가격 * 수량의 합은 10000원 이상어햐 합니다 현재값="+resultPrice));
            }
        }
    ...
    public String addItemV2(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        ...
        if (item.getPrice() == null || item.getPrice() != null && (item.getPrice() < 1000 || item.getPrice() > 100000)) {
            bindingResult.addError(new FieldError("item", "price", item.getPrice(), false, null, null, "가격은 1000 ~100,000 사이입니다"));
        }
    ...
    public String addItemV3(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        ...
        if (!StringUtils.hasText(item.getItemName())) {
            ...
            bindingResult.addError(new FieldError("item", "itemName", item.getItemName(), false, new String[] {"required.item.itemName"}, null, "defualt 오류"));
